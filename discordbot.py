...
TOKEN = 'NzA1NjY1MjY4OTMxNjI1MDEw.XxGLaQ.MGsnUcUtLi1oBqUlrHnfFRIACYw'
...
async def on_message(message):
    ...
    if test_blacklist == 1:
        ...
        await message.channel.send(
            message.content.lower().translate(str.maketrans({chr(0xFF01 + i): chr(0x21 + i) for i in range(94)})))
